...
namespace Application.Services.Account
{
    public class AccountService : ServiceBase<UserRepository, User, UserDto, Guid>, IAccountService
    {
        ...
        private string GenerateToken(UserDto user)
        {
            ...
            var jwtClaims = new List<System.Security.Claims.Claim>
            {
            ...
            {
                jwtClaims.Add(new System.Security.Claims.Claim("perms", userClaim));
            }
        ...
        private async Task<ICollection<string>> GetUserClaims(User u)
        {
            ...
            return roleClaims.Select(p => p.Claim!.Name).Distinct().ToList();
        }
    }
}
